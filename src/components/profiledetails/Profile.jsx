  ...
  const [img, setImg] = useState()
    ...
    const handleSave = () => {
        ...
        if(firstName === '' || lastName === '' || email === ''){
            ...
            dataArray.profileImg = base64Url
    ...
    <div>
        <div className="px-[2rem] py-[1rem] w-[100%] h-[580px] m-5 bg-purple-50 rounded-md shadow-md shadow-slate-200">
            ...
            <div className='flex items-center gap-10 bg-gray-50 px-[1rem] py-[1rem] shadow-md shadow-slate-100'>
                <input type="file" onChange={handleFileChange} accept='.jpg, .png, .jpeg' />
                ...
                {base64Url ? <img src={base64Url} alt="Uploaded" className='rounded-lg object-cover mt-[4px] mx-auto h-[120px] w-[120px]' />:<div className=' rounded-lg bg-stone-700 mt-[4px] mx-auto h-[120px] w-[120px]'></div>}
